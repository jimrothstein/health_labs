...
####  Fecal_fatty_acids (g/24 hours)
  ...
  *  Let me get this straight,  for 1st test 34 g/day * 3 days out of total 834 

```{r fecal_fats}

fecal_fats  <- data.table(date=c("10/31/18", "4/2/19","5/24/21" ),
                          test_length = c(48,72,72),
...
plot(fecal_fats$total_fecal_wt, fecal_fats$fatty_acids)
